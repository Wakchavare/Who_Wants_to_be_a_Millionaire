...
public class ThirteenthQuestionActivity extends AppCompatActivity {
            ...
            public void onClick(View v) {
                if (!answerConfirmed) {
                    ...
                    if (selectedOptionIndex != -1) {
                        ...
                        Toast.makeText(ThirteenthQuestionActivity.this, "Please select an option!", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(ThirteenthQuestionActivity.this, "Answer already confirmed!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void moveToNextQuestion() {
        ...
        // Move to the ThirdQuestionActivity and pass the updated currentPrizeIndex
        Intent intent = new Intent(this, FourteenthQuestionActivity.class);
