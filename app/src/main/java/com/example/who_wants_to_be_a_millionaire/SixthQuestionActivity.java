...
public class SixthQuestionActivity extends AppCompatActivity {
    ...
    private String question = "What is the highest mountain in the world?";
    private String[] options = {"Mount Kilimanjaro", "Mount Everest", "Mount Fuji", "Mount McKinley"};
            ...
            public void onClick(View v) {
                if (!answerConfirmed) {
                    ...
                    if (selectedOptionIndex != -1) {
                        ...
                        Toast.makeText(SixthQuestionActivity.this, "Please select an option!", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(SixthQuestionActivity.this, "Answer already confirmed!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void moveToNextQuestion() {
        ...
        // Move to the ThirdQuestionActivity and pass the updated currentPrizeIndex
        Intent intent = new Intent(this, SeventhQuestionActivity.class);
