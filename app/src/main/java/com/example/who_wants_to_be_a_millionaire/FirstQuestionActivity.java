...
public class FirstQuestionActivity extends AppCompatActivity {
    ...
    private String[] options = {"London", "Paris", "Berlin", "Rome"};
            ...
            public void onClick(View v) {
                if (!answerConfirmed) {
                    ...
                    if (selectedOptionIndex != -1) {
                        ...
                        Toast.makeText(FirstQuestionActivity.this, "Please select an option!", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(FirstQuestionActivity.this, "Answer already confirmed!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void checkAnswer(int selectedOption) {
        if (selectedOption == correctAnswerIndex) {
            ...
            // Move to the SecondQuestionActivity and pass the updated currentPrizeIndex
            moveToNextQuestion();
        } else {
            // Incorrect answer
