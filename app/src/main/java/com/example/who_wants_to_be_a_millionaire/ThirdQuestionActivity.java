            ...
            public void onClick(View v) {
                if (!answerConfirmed) {
                    ...
                    if (selectedOptionIndex != -1) {
                        ...
                        Toast.makeText(ThirdQuestionActivity.this, "Please select an option!", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(ThirdQuestionActivity.this, "Answer already confirmed!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
