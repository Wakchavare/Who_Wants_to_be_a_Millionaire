...
public class SeventhQuestionActivity extends AppCompatActivity {
    ...
    private String question = "Which planet is known as the \"Morning Star\" or \"Evening Star\"?";
    private String[] options = {"Mercury", "Mars", "Venus", "Jupiter"};
            ...
            public void onClick(View v) {
                if (!answerConfirmed) {
                    ...
                    if (selectedOptionIndex != -1) {
                        ...
                        Toast.makeText(SeventhQuestionActivity.this, "Please select an option!", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(SeventhQuestionActivity.this, "Answer already confirmed!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void moveToNextQuestion() {
        ...
        // Move to the ThirdQuestionActivity and pass the updated currentPrizeIndex
        Intent intent = new Intent(this, EighthQuestionActivity.class);
