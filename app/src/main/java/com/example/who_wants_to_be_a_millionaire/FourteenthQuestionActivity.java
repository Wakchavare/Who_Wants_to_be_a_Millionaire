...
public class FourteenthQuestionActivity extends AppCompatActivity {

    private String question = "Who is credited with inventing the World Wide Web?";
    private String[] options = {"Bill Gates", "Tim Berners-Lee", "Steve Jobs", "Mark Zuckerberg"};
            ...
            public void onClick(View v) {
                if (!answerConfirmed) {
                    ...
                    if (selectedOptionIndex != -1) {
                        ...
                        Toast.makeText(FourteenthQuestionActivity.this, "Please select an option!", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(FourteenthQuestionActivity.this, "Answer already confirmed!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void moveToNextQuestion() {
        ...
        // Move to the ThirdQuestionActivity and pass the updated currentPrizeIndex
        Intent intent = new Intent(this, FifteenthQuestionActivity.class);
